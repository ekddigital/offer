          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Have questions about our products or sourcing capabilities?
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand-secondary/10">
                  <svg
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Join our group for fastest response
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold">Global Sourcing</h3>
                  <p className="text-sm text-muted-foreground">
                    Direct connections with China&apos;s top suppliers
                  </p>
                </div>
              </div>
            </div>
